...
void AOpenXRSimDemoPawn::Tick(float DeltaSeconds)
{
	...
	const float LT = PC->GetInputAnalogKeyState(EKeys::MotionController_Left_TriggerAxis);
	const float RT = PC->GetInputAnalogKeyState(EKeys::MotionController_Right_TriggerAxis);
